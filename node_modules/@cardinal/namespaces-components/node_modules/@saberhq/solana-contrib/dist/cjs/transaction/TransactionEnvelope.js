...
const computeBudget_1 = require("../computeBudget");
const utils_1 = require("../utils");
const txSizer_1 = require("./txSizer");
...
class TransactionEnvelope {
    ...
    estimateSizeUnsafe() {
        ...
        return (0, txSizer_1.calculateTxSizeUnsafe)(builtTx);
    }
    /**
     ...
     */
    estimateSize() {
        return (0, utils_1.suppressConsoleError)(() => {
            try {
                const builtTx = this.build();
                // dummy blockhash that is required for building the transaction
                builtTx.recentBlockhash = "MaryHadALittLeLambZNdhAUTrsLE1ydg6rmtvFEpKT";
                ...
                return { error: new utils_1.TXSizeEstimationError(e) };
            }
        });
    }
    /**
    ...
    generateInspectLink(cluster = "mainnet-beta") {
        const t = this.build();
        t.recentBlockhash = utils_2.RECENT_BLOCKHASH_STUB;
        const str = t.serializeMessage().toString("base64");
        return (0, utils_2.generateInspectLinkFromBase64)(cluster, str);
    }
    /**
    ...
    simulateTable(opts) {
        return this.simulate(opts).then((simulation) => {
            ...
            if ((_a = simulation === null || simulation === void 0 ? void 0 : simulation.value) === null || _a === void 0 ? void 0 : _a.logs) {
                (0, utils_1.printTXTable)(this, simulation.value.logs, "");
            }
            return simulation;
        });
    }
     ...
     */
    addMemo(memo) {
        this.instructions.push((0, utils_1.createMemoInstruction)(memo));
        return this;
    }
    /**
    ...
    addAdditionalComputeBudget(units, additionalFee) {
        this.instructions.unshift((0, computeBudget_1.requestComputeUnitsInstruction)(units, additionalFee));
        return this;
    }
    /**
    ...
    addAdditionalHeapFrame(bytes) {
        this.instructions.unshift((0, computeBudget_1.requestHeapFrameInstruction)(bytes));
        return this;
    }
}
