...
async function signTransaction(transport, transaction, derivationPath = getSolanaDerivationPath()) {
    const messageBytes = transaction.serializeMessage();
    return signBytes(transport, messageBytes, derivationPath);
}
exports.signTransaction = signTransaction;
async function signBytes(transport, bytes, derivationPath = getSolanaDerivationPath()) {
...
async function getPublicKey(transport, derivationPath = getSolanaDerivationPath()) {
