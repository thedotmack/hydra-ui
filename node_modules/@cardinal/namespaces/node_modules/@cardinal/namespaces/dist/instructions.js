...
exports.withRevokeEntry = exports.withRevokeReverseEntry = exports.withSetReverseEntry = exports.withSetEntryData = exports.withClaimEntry = exports.withUpdateClaimRequest = exports.withCreateClaimRequest = exports.withInitEntry = exports.withUpdateNamespace = exports.withCreateNamespace = exports.withInit = void 0;
...
async function withCreateClaimRequest(connection, wallet, namespaceName, entryName, user, transaction) {
    ...
    transaction.add(namespacesProgram.instruction.createClaimRequest(claimRequestBump, user, {
        accounts: {
            namespace: namespaceId,
            entry: entryId,
            payer: provider.wallet.publicKey,
...
async function withRevokeEntry(connection, wallet, namespaceName, entryName, certificateMintId, certificateOwnerId, claimRequestId, transaction) {
    ...
    const userPaymentTokenAccountId = await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, namespace.paymentMint, certificateOwnerId);
    const certificateTokenAccountId = await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, certificateMintId, certificateId, true);
