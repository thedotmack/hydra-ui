...
import { ReceiptType, STAKE_POOL_IDL, stakePoolProgram, } from "./programs/stakePool";
...
import { withAddToGroupEntry, withAuthorizeStakeEntry, withInitGroupStakeEntry, withInitStakeEntry, withInitStakeMint, withInitStakePool, withInitUngrouping, withRemoveFromGroupEntry, withUpdateTotalStakeSeconds, } from "./programs/stakePool/transaction";
...
export const claimGroupRewards = async (connection, wallet, params) => {
    ...
    if (!groupRewardEntry) {
        ...
        const stakeEntries = await Promise.all(stakeEntriesData.map((stakeEntry) => {
            const rewardDistributorId = findRewardDistributorId(stakeEntry.parsed.pool);
            return {
