...
exports.createProcessAddMemberNftInstruction = void 0;
...
function createProcessAddMemberNftInstruction(accounts, args) {
    ...
    const [data] = processAddMemberNftStruct.serialize(Object.assign({ instructionDiscriminator: processAddMemberNftInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: authority,
            isWritable: true,
