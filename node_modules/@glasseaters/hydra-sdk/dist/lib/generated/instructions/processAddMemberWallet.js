...
exports.createProcessAddMemberWalletInstruction = void 0;
...
function createProcessAddMemberWalletInstruction(accounts, args) {
    ...
    const [data] = processAddMemberWalletStruct.serialize(Object.assign({ instructionDiscriminator: processAddMemberWalletInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: authority,
            isWritable: true,
