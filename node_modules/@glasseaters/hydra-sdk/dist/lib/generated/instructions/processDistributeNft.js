...
exports.createProcessDistributeNftInstruction = void 0;
...
function createProcessDistributeNftInstruction(accounts, args) {
    ...
    const [data] = processDistributeNftStruct.serialize(Object.assign({ instructionDiscriminator: processDistributeNftInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: payer,
            isWritable: false,
