...
exports.createProcessDistributeTokenInstruction = void 0;
...
function createProcessDistributeTokenInstruction(accounts, args) {
    ...
    const [data] = processDistributeTokenStruct.serialize(Object.assign({ instructionDiscriminator: processDistributeTokenInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: payer,
            isWritable: false,
