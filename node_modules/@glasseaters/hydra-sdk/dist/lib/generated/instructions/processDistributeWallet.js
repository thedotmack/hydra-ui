...
exports.createProcessDistributeWalletInstruction = void 0;
...
function createProcessDistributeWalletInstruction(accounts, args) {
    ...
    const [data] = processDistributeWalletStruct.serialize(Object.assign({ instructionDiscriminator: processDistributeWalletInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: payer,
            isWritable: false,
