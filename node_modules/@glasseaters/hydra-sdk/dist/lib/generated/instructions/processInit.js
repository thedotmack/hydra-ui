...
exports.createProcessInitInstruction = void 0;
...
function createProcessInitInstruction(accounts, args) {
    ...
    const [data] = processInitStruct.serialize(Object.assign({ instructionDiscriminator: processInitInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: authority,
            isWritable: true,
