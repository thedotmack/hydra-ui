...
exports.createProcessSetForTokenMemberStakeInstruction = void 0;
...
function createProcessSetForTokenMemberStakeInstruction(accounts, args) {
    ...
    const [data] = processSetForTokenMemberStakeStruct.serialize(Object.assign({ instructionDiscriminator: processSetForTokenMemberStakeInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: authority,
            isWritable: true,
