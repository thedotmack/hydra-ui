...
exports.createProcessSetTokenMemberStakeInstruction = void 0;
...
function createProcessSetTokenMemberStakeInstruction(accounts, args) {
    ...
    const [data] = processSetTokenMemberStakeStruct.serialize(Object.assign({ instructionDiscriminator: processSetTokenMemberStakeInstructionDiscriminator }, args));
    const keys = [
        {
            pubkey: member,
            isWritable: true,
