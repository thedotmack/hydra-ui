...
exports.LangErrorMessage = new Map([
    ...
    [
        exports.LangErrorCode.AccountNotProgramOwned,
        "The given account is not owned by the executing program",
    ],
    [exports.LangErrorCode.InvalidProgramId, "Program ID was not as expected"],
    [
        exports.LangErrorCode.InvalidProgramIdExecutable,
...
class ProgramError {
    ...
    static parse(err) {
        ...
        let errorMsg = ((_b = (0, errors_1.errorFromCode)(errorCode)) === null || _b === void 0 ? void 0 : _b.toString()) ||
